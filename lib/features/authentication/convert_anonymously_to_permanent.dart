...
part 'convert_anonymously_to_permanent.g.dart';

@riverpod
Future<void> convertAnonymouslyToPermanent(
  ConvertAnonymouslyToPermanentRef ref,
  ...
  try {
    ...
    await read(authRepositoryImplProvider)
        .convertAnonymouslyToPermanent(credential);
    onSuccess();
    debugPrint('ログインしました');
